...
if ((mes == 0) || (mes == 1) || (dia <= 21 && mes == 2) || (mes == 11 && dia > 21)) {
    ...
    document.body.style.backgroundImage = "url('imagens/verao.jpg')"
}
...
if ((mes == 3) || (mes == 4) || (dia <= 21 && mes == 5) || (mes == 2 && dia > 21)) {
    ...
    document.body.style.backgroundImage = "url('imagens/outono.jpg')"
}
...
if ((mes == 6) || (mes == 7) || (dia <= 21 && mes == 8) || (mes == 5 && dia > 21)) {
    ...
    document.body.style.backgroundImage = "url('imagens/inverno.jpg')"
}
...
if ((mes == 9) || (mes == 10) || (dia <= 21 && mes == 11) || (mes == 8 && dia > 21)) {
    ...
    document.body.style.backgroundImage = "url('imagens/primavera.jpg')"
}